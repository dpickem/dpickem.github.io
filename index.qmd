...
::: {.column-page .alert .alert-warning style="text-align: center; margin-bottom: 2em; padding: 1em; border: 2px solid #f0ad4e; background-color: #fcf8e3; border-radius: 5px;"}
<i class="bi bi-exclamation-triangle-fill" style="font-size: 1.5em; vertical-align: middle; margin-right: 0.5em;"></i> <span style="font-weight: bold; font-size: 1.2em;">This site is currently under construction. Content may be incomplete or change frequently (including the logo).</span>
:::
...
<a href="https://www.linkedin.com/danielpickem/" target="_blank"><i class="bi bi-linkedin"></i></a>
